...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent registerInstant=new Intent(LoginActivity.this,RegisterActivity.class);
                startActivity(registerInstant);
       ...
       loginButton.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View view) {
               mail=loginName.getText().toString();
    ...
    public void Login(String loginName, String loginPassword){
        ...
        if (!TextUtils.isEmpty(loginName)&&!TextUtils.isEmpty(loginPassword)){
            ...
            mAuth.signInWithEmailAndPassword(loginName,loginPassword).addOnCompleteListener(
